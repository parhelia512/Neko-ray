...
@Obfuscate
public final class KeyboxImitationHooks {
    private static final String TAG = "mobxprjkt";
    ...
    static {
        try {
            String realName = KeyboxImitationHooks.class.getName();
			if (!"mobx.spoof.security.keystore.KeyboxImitationHooks".equals(realName)) {
				throw new RuntimeException("Hello Kang!!!");
			}
            ...
            EC_CERTS.add(parseCert(Keybox.EC.CERTIFICATE_4));
            ...
            RSA_CERTS.add(parseCert(Keybox.RSA.CERTIFICATE_4));
        } catch (Throwable t) {
